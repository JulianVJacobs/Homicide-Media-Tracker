                ...
                <tbody>
                  {duplicateData.map((entry) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        {new Date(entry.date_of_publication).toLocaleDateString(
                          "en-gb"
                        )}
                      </td>
                      ...
                      <td className="px-6 py-4">
                        {entry.date_of_death
                          ? new Date(entry.date_of_death).toLocaleDateString(
                              "en-gb"
                            )
                          : ""}
                      </td>
                      ...
                      <td className="px-6 py-4">{entry.place_of_death_town}</td>
                      <td className="px-6 py-4">{entry.type_of_location}</td>
                      <td className="px-6 py-4">{entry.sexual_assault}</td>
                      <td className="px-6 py-4">{entry.gender_of_victim}</td>
                      <td className="px-6 py-4">{entry.race_of_victim}</td>
                      <td className="px-6 py-4">{entry.age_of_victim}</td>
                      <td className="px-6 py-4">{entry.age_range_of_victim}</td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4">{entry.perpetrator_name}</td>
                      <td className="px-6 py-4">
                        {entry.perpetrator_relationship_to_victim}
                      </td>
                      <td className="px-6 py-4">{entry.suspect_identified}</td>
                      <td className="px-6 py-4">{entry.suspect_arrested}</td>

...
- 🟠 Runtime requirement update: AtoM host provisioning must be produced in this repository (no external pre-existing AtoM instance assumed).
- 🟠 Active fleet proposal: `3.1.0` host-provisioning + runtime-binding phase prepared for launch.

...
1. Copy `/home/runner/work/Homicide-Media-Tracker/Homicide-Media-Tracker/infrastructure/atom-stack/.env.example` to a local env file (for example `infrastructure/atom-stack/.env.local`).
